...
MODEL_NAME="act-v3"
CHECKPOINT="200000"
TASK_ID="${TASK_ID:-LeIsaac-HCIS-DiningCleanup-SingleArm-v0}"
DINING_CLEANUP_CONFIG="configs/dining_cleanup/fork_bowl2_scaled.json"
RUN_STAMP="$(date +%Y%m%d_%H%M%S)"
MODEL_DIR_REL="experiments/advance/${MODEL_NAME}/checkpoint/checkpoints/${CHECKPOINT}/pretrained_model"
VIDEO_DIR_REL="experiments/advance/${MODEL_NAME}/rollout_${CHECKPOINT}_${RUN_STAMP}_videos"
LOG_REL="experiments/advance/${MODEL_NAME}/rollout_${CHECKPOINT}_${RUN_STAMP}.log"
...
echo "=== rollout_advance finished ===" | tee -a "$HOST_LOG_FILE"
date | tee -a "$HOST_LOG_FILE"
exit "$STATUS"
