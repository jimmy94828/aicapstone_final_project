...
HF_USER="AI-Final"
DATASET_REPO_ID="${HF_USER}/AI-aiCapstoneData-lerobot-cutlery-v7-84"
TASK_ID="HCIS-CutleryArrangement-SingleArm-v0"
OBJECT_POSES="data/umi/umi84/object_poses.json"
HF_TOKEN=""
LOG="${WORKSPACE}/datagen_v7-84.log"
...
docker run --rm \
    ...
    -e HF_TOKEN="${HF_TOKEN}" \
    -e HF_USER="${HF_USER}" \
    -e DATAGEN_VIDEO_DIR=/workspace/aicapstone/datagen_v7-84_preview/videos \
    "${IMAGE}" \
    bash -lc "
        set -euo pipefail
